...
const English = () => {
    ...
    const songs = [
        { title: 'Daddys home', album: 'Essence', duration: '3:57', src: 'moi.mp3', image: 'dad.jpg' },
        { title: 'Nonsense', album: ' Emails I Cant Send', duration: '4:41', src: 'sab.mp3', image: 'non.jpg' },
        { title: 'Say it', album: ' I Told You', duration: '5:30', src: 'tor.mp3', image: 'sayit.jpg' },
        { title: 'diet mountain dew', album: 'Born To Be', duration: '2:38', src: 'di.mp3', image: 'diet.jpg' },
        { title: 'name of love', album: 'In the Name of Love: Artists United for Africa', duration: '4:08', src: 'bebe.mp3', image: 'namelove.jpg' },
        { title: 'daylight', album: 'Lover', duration: '3:45', src: 'lig.mp3', image: 'daylight.jpg' },
        { title: 'we cant be friends', album: 'Eternal Sunshine', duration: '4:20', src: 'cannt.mp3', image: 'wecant.jpg' }
    ];
